...
class SourceMenu:
    ...
    def __init__(self, mode_interface):
        ...
        source_autopep8_mi = Gtk.MenuItem.new_with_label("Use gofmt")
    ...
    def on_source_gofmt_mi(self, mi):
...
class ModeInterface:
    ...
    def set_buffer(self, buff):
        ...
        buff.set_language(self.lang_mgr.get_language('go'))
